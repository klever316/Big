function listaProcessosPendentes(data_ajax,key,name){
    $("#corpo").empty();
...
function carregarGraficoPendentesPorCompetencia(data_competencia, data_varas){
                        ...
                        click: function () {
                            ...
                            $.ajax({
                                ...
                                success: function(data, textStatus, jqXHR) {
                                    ...
                                    listaProcessosPendentes(data.array, data.array[0].orju_dsc_unidade, options.series.name);
                                },
                            });
                        }
                    }
...
function carregarGraficoPendentesComarcaFortaleza(processos_pendentes){
