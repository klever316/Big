			...
			@@consulta_baixados_por_competencia.each_with_index do |row, i|
				if(a == row["pedi_num_ano"])
					if row["orju_dsc_unidade"].to_s.include? "VARA DE FAMILIA DA COMARCA DE FORTALEZA"
						...
						@varas_familia += [{ name: "#{x}", y: row['baixados'], key: "#{row["orju_dsc_unidade"]}"}]
						...
						if !row["orju_dsc_unidade"].to_s.include? "6ª VARA DO JURI"
							...
							@varas_juri += [{ name: "#{x}", y: row['baixados'], key: "#{row["orju_dsc_unidade"]}"}]
						end
						...
						if !row["orju_dsc_unidade"].to_s.include? "19ª VARA CRIMINAL DA COMARCA DE FORTALEZA"
							...
							@varas_criminais += [{ name: "#{x}", y: row['baixados'], key: "#{row["orju_dsc_unidade"]}"}]
						end
						...
						if !row["orju_dsc_unidade"].to_s.include? "VARA CÍVEL DA COMARCA DE FORTALEZA-INATIVA"
							...
							@varas_civeis += [{ name: "#{x}", y: row['baixados'], key: "#{row["orju_dsc_unidade"]}"}]
						end
						...
						@varas_fazenda += [{ name: "#{x}", y: row['baixados'], key: "#{row["orju_dsc_unidade"]}"}]
						...
						@varas_infancia += [{ name: "#{x}", y: row['baixados'], key: "#{row["orju_dsc_unidade"]}"}]
						...
						@varas_execucoes_penais += [{ name: "#{x}", y: row['baixados'], key: "#{row["orju_dsc_unidade"]}"}]
						...
						@varas_execucoes_fiscais += [{ name: "#{x}", y: row['baixados'], key: "#{row["orju_dsc_unidade"]}"}]
						...
						@varas_falencia += [{ name: "#{x}", y: row['baixados'], key: "#{row["orju_dsc_unidade"]}"}]
						...
						@varas_registros_publicos += [{ name: "#{x}", y: row['baixados'], key: "#{row["orju_dsc_unidade"]}"}]
						...
						@varas_sucessoes += [{ name: "#{x}", y: row['baixados'], key: "#{row["orju_dsc_unidade"]}"}]
						...
						@varas_toxico += [{ name: "#{x}", y: row['baixados'], key: "#{row["orju_dsc_unidade"]}"}]
